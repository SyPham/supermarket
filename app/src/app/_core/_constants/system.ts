export class MessageConstants {
  public static SYSTEM_ERROR_MSG = 'An error occurred while connecting to the server 连接到服务器时发生错误';
  ...
  public static CREATED_OK_MSG = 'Successfully 成功地';
...
export class ImagePathConstants {
  public static NO_IMAGE = 'assets/images/pages/content-img-4.jpg';
